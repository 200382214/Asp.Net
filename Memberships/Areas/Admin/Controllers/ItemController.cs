...
namespace Memberships.Areas.Admin.Controllers
{
    ...
    public class ItemController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,Description,Url,ImageUrl,HTML,WaitDays,ProductId,ItemTypeId,PartId,SectionId,IsFree")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,Description,Url,ImageUrl,HTML,WaitDays,ProductId,ItemTypeId,PartId,SectionId,IsFree")] Item item)
        {
            if (ModelState.IsValid)
            {
